...
VISUAL_DIRECTIONS = [
    "premium product UI mockup on dark background, abstract charts blurred, interface-only composition",
    "empty early-morning workstation, closed journal, keyboard, coffee, silhouette-free composition",
    "close-up flat lay of notebook and keyboard, object-only composition",
    "abstract risk-control rails around a central decision point, text-free graphic",
    "clean SaaS dashboard cards for rules, validation, and risk, blurred placeholders only",
    "empty chair facing soft monitor glow, silhouette-free workstation scene",
    "split-screen concept: chaos vs discipline using abstract shapes only",
    "tactical rule-board style graphic with abstract blocks, no readable market-symbol labels",
    "premium editorial flat lay of keyboard, notebook, desk lamp, object-only composition",
    "dark fintech hero graphic with XeanVI-inspired geometric shapes",
    "abstract AI scanner/radar interface, symbol-free visual system",
    "minimal compliance-safe infographic layout, abstract blocks only",
    "product screenshot-style mockup with blurred placeholders only",
    "cinematic workstation scene, object-only composition",
...
IMAGE_RULES = [
    ...
    "For automated posts, image_prompt must describe object-only, product UI, abstract editorial, or empty-workstation scenes.",
    "Use negative_prompt for anatomy exclusions and defect blocking terms.",
    "Do not require anatomy terms in image_prompt; keep anatomy exclusions in negative_prompt.",
